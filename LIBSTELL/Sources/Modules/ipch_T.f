...
!  Supercedes and replaces the ipsl coding
!
!*******************************************************************************
!  MODULE ip_T
...
!                               - 'p' - polarimetry (not yet implemented)
!-------------------------------------------------------------------------------
      TYPE ipch_desc
...
!-------------------------------------------------------------------------------
         ...
         CHARACTER(LEN=1), OPTIONAL, INTENT(in)     :: ip_type
...
!  Assignments    
         ...
         this % ip_type = 'i'        ! Only allowable type - at this time
